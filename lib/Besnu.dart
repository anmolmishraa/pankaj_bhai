// ignore_for_file: use_key_in_widget_constructors, file_names, duplicate_ignore, prefer_const_constructors, non_constant_identifier_names, avoid_print, unnecessary_null_comparison, prefer_typing_uninitialized_variables, prefer_final_fields, import_of_legacy_library_into_null_safe
import 'dart:convert';
...
class Besnu extends StatefulWidget {
  @override
  _BesnuState createState() => _BesnuState();
}

class _BesnuState extends State<Besnu> {
  List Response = [];
  Map? mapResponse;
  var role;
  ...
  Future createAlbum() async {
    ...
    final response = await http.get(
      Uri.parse('http://myapi74052.somee.com/api/PostInfo/GetPostList/2'),
      headers: {
