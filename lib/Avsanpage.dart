// ignore_for_file: use_key_in_widget_constructors, file_names, duplicate_ignore, prefer_const_constructors, non_constant_identifier_names, avoid_print, unnecessary_null_comparison, prefer_typing_uninitialized_variables, prefer_final_fields, curly_braces_in_flow_control_structures, import_of_legacy_library_into_null_safe
import 'dart:convert';
...
class Avsanpage extends StatefulWidget {
  @override
  _AvsanpageState createState() => _AvsanpageState();
}

class _AvsanpageState extends State<Avsanpage> {
  List Response = [];
  Map? mapResponse;
  ...
  Future createAlbum() async {
    ...
    final response = await http.get(
      Uri.parse('http://myapi74052.somee.com/api/PostInfo/GetPostList/1'),
      headers: {
